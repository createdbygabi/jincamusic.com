export default function SocialIcons() {
  const socialLinks = [
    ...
    {
      name: "Spotify",
      url: "https://open.spotify.com/artist/jinca",
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: "SoundCloud",
      url: "https://soundcloud.com/jinca",
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 19V9l4-2v12M5 17V7l4-2v12M13 15V5l4-2v12M17 13H3" />
        </svg>
      ),
    },
    {
      name: "Apple Music",
      url: "https://music.apple.com/artist/jinca",
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
